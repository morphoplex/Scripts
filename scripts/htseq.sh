...
python -m HTSeq.scripts.count -f bam -r name -s reverse -t exon -i gene_id /projects/researchers/researchers01/jonbra/Mnemiopsis/tophat/${SAMPLE_ID}/accepted_hits_sorted.bam /projects/researchers/researchers01/jonbra/Mnemiopsis/assemblies/MergedAssemblies/merged_fixed.gtf > /projects/researchers/researchers01/jonbra/Mnemiopsis/assemblies/HTSeq_counts/HTSeq_${SAMPLE_ID}.txt
